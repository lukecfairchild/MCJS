...
var Directory = function ( fileInfo ) {


	var resolvePath = function ( rawDirPath ) {
	...
	this.create = function ( dirPath ) {

		var path = resolvePath( dirPath );
